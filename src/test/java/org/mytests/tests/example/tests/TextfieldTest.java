...
public class TextfieldTest extends SimpleTestsInit {
    ...
    public void longTextTest() {
        ...
        textfieldTask.enterTextInField(text);
        writeInFile(format("Dropdown Task(%s) Time: %s, ", textfieldTask.NAME, timer.getTime()));
        System.out.println(textfieldTask.NAME + "; Time: " + timer.getTime());
    }
    @AfterMethod
